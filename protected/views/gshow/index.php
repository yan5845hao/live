...
<script text="text/javascript" src="js/jquery-1.7.2.min.js"></script>
</head>
<body>
<div class="top">
	<div class="logo left"><img src="images/logo.png" /><span>最大的明星粉丝互动娱乐平台</span></div>
	<div class="search left"><input type="text" value="刘德华" /><button></button></div>
	<div class="login left"><a href="" target="_blank" class="c-gap-left">【登录】</a><a href="" target="_blank">【注册】</a></div>
...
<div class="nav">
	<div class="nav_inner">
		<ul>
			...
			<li class="current"><a href="" target="_blank">大枷秀</a></li>
			<li><a href="" target="_blank">明星档</a></li>
			<li><a href="" target="_blank">星愿城</a></li>
			<li><a href="" target="_blank">大牌店</a></li>
			<li><a href="" target="_blank">粉社会</a></li>
		</ul>
	</div>
</div>
