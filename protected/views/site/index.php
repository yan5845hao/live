...
(function() {
    ...
    var N = (function() {
        function C() {
            ...
            for (var a = 0; a < c.length; a++) {
                ...
                X.style.top = Math.floor(a / 7) * 52 + "px";
                var b = R("DIV");
                b.className = "so";
                ...
                var Y = R("DIV");
                if (c[a].isToday) {
                    //X.style.border = "1px solid #ffbb00";
                    //X.style.background = "#ffbb00"
                    X.className = "cur";
                    Y.className = "c-999999";
                    b.className = ((a % 7) > 4 || c[a].isRest) ? "c-c60b02": "c-313131";
                }else{
                    b.className = ((a % 7) > 4 || c[a].isRest) ? "c-c60b02": "c-313131";
                    Y.className = "c-999999";
                }
    ...
    var F = (function() {
        ...
        function G(b) {
            ...
            //console.log(b.cell);
            //console.log(b.dateIndex);
            //console.log(Q.getJson().dateArray[b.dateIndex]);
...
<div class="col_right right">
    ...
    <ul>
        <li>
            ...
            <div class="des left">
                <h5>鹿晗粉丝见面会</h5>
                <div><span class="time">时间</span><span class="address">地点</span></div>
            </div>
        </li>
        <li>
            <div class="headbox left">
